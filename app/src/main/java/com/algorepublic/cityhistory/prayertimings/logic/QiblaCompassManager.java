...
package com.algorepublic.cityhistory.prayertimings.logic;
...
public class QiblaCompassManager implements SensorEventListener,
    ...
    private final QiblaFragment qiblaActivity;
    ...
    public QiblaCompassManager(QiblaFragment qiblaActivity) {
