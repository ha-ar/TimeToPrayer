...
//        Log.e("Perfs Default Preferences", perfs.toString());
...
//            Log.e("Perfs", String.valueOf(isGPS));
...
////        Boolean test=perfs.getBoolean(getString(R.string.gps_pref_key), false);
////        Log.e("Perfs", test.toString());
